...
- `AGENTS.md`
- `.agents/skills/beedrill-implement-issue/SKILL.md`
- `.agents/skills/beedrill-verify-and-correct/SKILL.md`
...
Verify the exact target, branch, Issue, repository boundaries, and applicable
skills.
...
2. `Codex verification and correction`
   ...
   - verify every Acceptance Criterion without relying on the first executor's
     report;
...
- include the Issue source when supplied and the same compact snapshot of the
  approved task contract: Summary, Scope, Excluded, Deliverable, Acceptance
  Criteria, Change level, required checks, and task-specific constraints;
